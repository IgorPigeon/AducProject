...
<div class="container">
  	<div class="row align-items-start">
  		<div class="card-body" style="background: #2e3d4d">
  			<img src="mentalray.png" class="card-img-top" style="margin-left: 10%; width: 80%; background: white;"><br><br>
  			<figcaption style="text-align: right; color: #131820; margin-left: 13%; width: 75%;">Логотип графического движка</figcaption><br><br>
			<h5 class="card-title">mental ray</h5>
			<br>
			<p class="card-text">
				<b>mental ray</b> - физически корректная система рендеринга (имеется в виду, что все расчёты света/энергии/каустики и т. д. происходят взаимозависимо, что и отличает его от других рендереров, где всё обрабатывается раздельно и определяется самим пользователем).
			<br><br>
    	...
    	<div class="col">
          	<a href="..\Brazil R-S\BrazilR-S.php" class="btn btn-primary">
				<div class="card">
    	...
    	<div class="col">
          	<a href="..\Maxwell Render\MaxwellRender.php" class="btn btn-primary"  style="width: 100%">
				<div class="card">
				 	<div class="card-body" style="color: #d0e6f6;">
